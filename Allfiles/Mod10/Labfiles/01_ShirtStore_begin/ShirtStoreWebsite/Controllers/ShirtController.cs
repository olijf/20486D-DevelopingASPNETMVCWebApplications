...
namespace ShirtStoreWebsite.Controllers
{
    public class ShirtController : Controller
    {
        ...
        public ShirtController(IShirtRepository repository, ILogger<ShirtController> logger) => (_repository, _logger) = (repository, logger);
        ...
        public IActionResult Delete(int id)
        {
            ...
            {
                _logger.LogError($"An error occured while trying to delete shirt with id of {id}.");
                throw ex;
            }
        }
    }
